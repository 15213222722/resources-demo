...
public class RSAEncrypt {
	...
	public static void test(String priKey, String pubKey) {
		...
		// 加载私钥
		try {
			rsaEncrypt.loadPrivateKey(priKey);
		...
		// 测试字符串
		String encryptStr = "Test String danguanghong";

		try {
			byte[] asd = rsaEncrypt.getPublicKey().getEncoded();
			System.out.println(new String(Base64.encode(asd)));

			asd = rsaEncrypt.getPrivateKey().getEncoded();
			System.out.println(new String(Base64.encode(asd)));

			// 加密
			byte[] cipher = rsaEncrypt.encrypt(rsaEncrypt.getPublicKey(), encryptStr.getBytes());
			System.out.println(new String(Base64.encode(cipher)).length());
			// cipher
			// =Base64.decode("DMB6DwoOByUqtSaI3Oufgz0b7i3c2mF6rPAc4dl0gs8f7hnhg0xGHFkw1k2ymhlzooQoCeI7IZ1T1amSL3jWixDTqDlGrD3wZ5A/OqyOF7Woed7JdgrsKOk3ZSoj9LEN8rEEQpFDQtK6Go00msfwPxQtWp9Bm+QjWJ8q411DAkU=");
			System.out.println(new String(Base64.encode(cipher)));
